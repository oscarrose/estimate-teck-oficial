...
public partial class estimate_teckContext : DbContext
{
    ...
    public virtual DbSet<CaracteristicaSistema> CaracteristicaSistemas { get; set; }

    public virtual DbSet<Cargo> Cargos { get; set; }

    public virtual DbSet<Cliente> Clientes { get; set; }

    public virtual DbSet<ComponenteFuncionale> ComponenteFuncionales { get; set; }

    public virtual DbSet<ConteoTipoComponente> ConteoTipoComponentes { get; set; }

    public virtual DbSet<DetalleEstimacion> DetalleEstimacions { get; set; }

    public virtual DbSet<Empleado> Empleados { get; set; }

    public virtual DbSet<EstadoProyecto> EstadoProyectos { get; set; }

    public virtual DbSet<EstadoUsuarioEmpleado> EstadoUsuarioEmpleados { get; set; }

    public virtual DbSet<Estimacion> Estimacions { get; set; }

    public virtual DbSet<HistorialProyecto> HistorialProyectos { get; set; }

    public virtual DbSet<ParametrosEconomico> ParametrosEconomicos { get; set; }

    public virtual DbSet<ParticipanteEstimacion> ParticipanteEstimacions { get; set; }

    public virtual DbSet<ProductividadPuntoFuncion> ProductividadPuntoFuncions { get; set; }

    public virtual DbSet<Proyecto> Proyectos { get; set; }

    public virtual DbSet<PuntoFuncionAjustado> PuntoFuncionAjustados { get; set; }

    public virtual DbSet<RequerimientosCliente> RequerimientosClientes { get; set; }

    public virtual DbSet<Rol> Rols { get; set; }

    public virtual DbSet<TarifarioHora> TarifarioHoras { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CaracteristicaSistemaId).HasName("PK_caracteristica_sistema_Id");
            ...
            entity.HasOne(d => d.Estimacion).WithMany(p => p.CaracteristicaSistemas)
        ...
        {
            entity.HasKey(e => e.CargoId).HasName("Pk_cargo_Id");
        ...
        {
            entity.HasKey(e => e.ComponenteFuncionalesId).HasName("Pk_Conponente_funcionales_Id");
            ...
            entity.HasOne(d => d.Estimacion).WithMany(p => p.ComponenteFuncionales)
                .HasForeignKey(d => d.EstimacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_estimacion_id_componente_funcionales");

            entity.HasOne(d => d.Requerimiento).WithMany(p => p.ComponenteFuncionales)
                .HasForeignKey(d => d.RequerimientoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_requerimiento_id_componente_funcionales");

            entity.HasOne(d => d.TipoComponente).WithMany(p => p.ComponenteFuncionales)
        ...
        {
            entity.HasKey(e => e.ConteoComponenteId).HasName("Pk_conteo_tipo_componente");
            ...
            entity.HasOne(d => d.Estimacion).WithMany(p => p.ConteoTipoComponentes)
                .HasForeignKey(d => d.EstimacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_estimacion_id_conteo_componente");

            entity.HasOne(d => d.TipoConponente).WithMany(p => p.ConteoTipoComponentes)
        ...
        {
            entity.HasKey(e => e.DetalleEstimacionId).HasName("FK_Detalle_Estimacion_Id");
            ...
            entity.HasOne(d => d.Estimacion).WithMany(p => p.DetalleEstimacions)
                .HasForeignKey(d => d.EstimacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.EstadoProyectoId).HasName("Pk_EstadoProyecto");
        ...
        {
            entity.HasKey(e => e.EstadoId).HasName("Pk_Estado_Empleado");
        ...
        {
            entity.HasKey(e => e.EstimacionId).HasName("Pk_Estimacion_Id");
            ...
            entity.HasOne(d => d.Productividad).WithMany(p => p.Estimacions)
                .HasForeignKey(d => d.ProductividadId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_ProductividadEstimacion_Id");

            entity.HasOne(d => d.Proyecto).WithMany(p => p.Estimacions)
        ...
        {
            entity.HasKey(e => e.HistorialProyectoId).HasName("Pk_HistorialProyecto_Id");
            ...
            entity.HasOne(d => d.Proyecto).WithMany(p => p.HistorialProyectos)
                .HasForeignKey(d => d.ProyectoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_HistorialProyecto_Id");

            entity.HasOne(d => d.Usuario).WithMany(p => p.HistorialProyectos)
        ...
        {
            entity.HasKey(e => e.ParametroEconomicoId).HasName("Pk_parametros_economicos_id");
            ...
            entity.HasOne(d => d.Estimacion).WithMany(p => p.ParametrosEconomicos)
                .HasForeignKey(d => d.EstimacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ParticipanteEstimacionId).HasName("PK_participante_estimacion_id");
            ...
            entity.HasOne(d => d.Cargo).WithMany(p => p.ParticipanteEstimacions)
                .HasForeignKey(d => d.CargoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_cargo_id_participante_estimacion");

            entity.HasOne(d => d.Estimacion).WithMany(p => p.ParticipanteEstimacions)
                .HasForeignKey(d => d.EstimacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ProductividadId).HasName("Pk_ProductividadId");
            ...
            entity.HasOne(d => d.Estado).WithMany(p => p.ProductividadPuntoFuncions)
                .HasForeignKey(d => d.EstadoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_EstadoProductividad_Id");

            entity.HasOne(d => d.Usuario).WithMany(p => p.ProductividadPuntoFuncions)
                .HasForeignKey(d => d.UsuarioId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ProyectoId).HasName("Pk_ProyectoId");
            ...
            entity.HasOne(d => d.EstadoProyecto).WithMany(p => p.Proyectos)
        ...
        {
            entity.HasKey(e => e.PuntoFuncionAjustadoId).HasName("Pk_punto_funcion_ajustado");
            ...
            entity.HasOne(d => d.Estimacion).WithMany(p => p.PuntoFuncionAjustados)
                .HasForeignKey(d => d.EstimacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_estimacion_id_punto_funcion_ajustado");

            entity.HasOne(d => d.TipoConponente).WithMany(p => p.PuntoFuncionAjustados)
                .HasForeignKey(d => d.TipoConponenteId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.RequerimientoId).HasName("Pk_RequerimientoCliente_Id");
            ...
            entity.HasOne(d => d.Proyecto).WithMany(p => p.RequerimientosClientes)
                .HasForeignKey(d => d.ProyectoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.TarifarioId).HasName("Pk_TarifarioId");
            ...
            entity.HasOne(d => d.Cargo).WithMany(p => p.TarifarioHoras)
                .HasForeignKey(d => d.CargoId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Fk_Cargo_Usuario");

            entity.HasOne(d => d.Usuario).WithMany(p => p.TarifarioHoras)
                .HasForeignKey(d => d.UsuarioId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.TipoId).HasName("Pk_TipoCliente");
        ...
        {
            entity.HasKey(e => e.TipoComponenteId).HasName("Pk_TipoComponente_Id");
